...
\name{Richard W.}{Thomas}
\position{Software Engineer Developer}
\address{45 Nectar Road Retreat Cape Town 7945 South Africa}

\mobile{(+27) 074432726}
\email{richard.thomas36@gmail.com}
\github{icemanx7}
% \gitlab{gitlab-id}
...
\recipient
  ...
  {Interfront \\Somerset-West}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Entry Level Java Developer}
% How the letter is opened
\letteropening{Dear Mr./Ms./Mrs.}
